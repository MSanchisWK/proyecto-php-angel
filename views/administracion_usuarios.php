...
<body>
    ...
    <header>        
        ...
        <nav>
			...
			<li><a href="administracion_usuarios.php" id="registro">USUARIOS-ADMINISTRACION</a></li>			
			<li><a href="administracion_citaciones.php">CITACIONES-ADMINISTRACION/a></li>
			<li><a href="listado_noticias_administracion_crud.php" id="index">NOTICIAS-ADMINISTRACION</a></li>
                        <li><a href='form_edit_usuario.php?idusuario=".$resul["idUser"]." & idlogin =".$resul["idUser"]."'>PERFIL</a></li>
...
?>
     <table> 
       ...
       <tr><td>Telefono:</td><td><?php echo $resultado['telefono']?></td><td><a href='form_edit_usuario.php?idusuario=".$resul["idUser"]." & idlogin =".l$resul["idUser"]."'>Editar usuario</a></td></tr>
